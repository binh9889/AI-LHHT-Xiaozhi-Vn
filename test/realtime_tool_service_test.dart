...
void main() {
  ...
  test('music search trả link provider online', () async {
    ...
    expect(result.externalUri!.host, 'music.youtube.com');
    expect(result.text, contains('không dùng kho 5 bài cục bộ'));
  });
}
