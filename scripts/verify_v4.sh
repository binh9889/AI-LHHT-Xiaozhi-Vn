...
echo '== AI-LHHT v4.1.3 Native Voice Weather Clean Pro source checks =='
grep -q '^version: 4.1.3+413$' pubspec.yaml
grep -q "static const String appVersion = '4.1.3';" lib/services/xiaozhi_provisioning_service.dart
