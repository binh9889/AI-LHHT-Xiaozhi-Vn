...
class _ConversationTypeScreenState extends State<ConversationTypeScreen> {
                  ...
                  onTap: () {
                    ...
                    if (difyConfigs.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Hãy thêm cấu hình Dify trong Cài đặt trước')),
                      );
                      return;
                    }
                ...
                child: InkWell(
                  onTap: () {
                    ...
                    if (xiaozhiConfigs.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Hãy thêm cấu hình dịch vụ Xiaozhi trong Cài đặt trước')),
                      );
                      return;
                    }
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Hỗ trợ trao đổi văn bản và giọng nói',
                          style: TextStyle(
                            color: Colors.grey.shade600,
                            fontSize: 14,
                          ),
          ...
          InkWell(
            onTap: () {
              ...
              if (minimaxConfigs.isEmpty) {
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Hãy thêm cấu hình MiniMax trong Cài đặt trước')),
                );
                return;
              }
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Mô hình MiniMax hỗ trợ hội thoại nhiều lượt',
                          style: TextStyle(
                            color: Colors.grey.shade600,
                            fontSize: 14,
                          ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  'Chọn dịch vụ giọng nói Xiaozhi muốn sử dụng',
                  style: TextStyle(fontSize: 15, color: Colors.grey.shade600),
                ),
              ],
            ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  'Chọn dịch vụ Dify API muốn sử dụng',
                  style: TextStyle(fontSize: 15, color: Colors.grey.shade600),
                ),
              ],
            ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text(
                  'Chọn dịch vụ MiniMax API muốn sử dụng',
                  style: TextStyle(fontSize: 15, color: Colors.grey.shade600),
                ),
              ],
            ),
  ...
  void _createDifyConversation(DifyConfig config) async {
    final conversation = await Provider.of<ConversationProvider>(
      ...
      title: 'Trò chuyện với ${config.name}',
